...
if not st.session_state['logged_in']:
    ...
    if selected_option =='Login':
        with c1:
            login()
        with c2:
            lottie_json = load_lottieurl("https://assets8.lottiefiles.com/packages/lf20_ktwnwv5m.json")
        ...
        with c1:
            signup()
        with c2:
            lottie_json = load_lottieurl("https://lottie.host/4954f2b6-8c0f-4e31-93f8-a5a4aa7a7ab5/LFeiNig55W.json")
            st_lottie(lottie_json)
else:
